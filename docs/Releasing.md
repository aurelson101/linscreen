...
- [ ] Update version and changelog at `packaging/rpm/linscreen.spec`
- [ ] Update `data/appdata/linscreen.metainfo.xml`
...
- [ ] Update flatpak manifest for Flathub: https://github.com/flathub/org.linscreen.LinScreen
- [ ] Push snapcraft edge release to stable
- [ ] If this is a major release coordinate with sign path on signed windows binaries
- [ ] Update change log on [website](https://github.com/linscreen/linscreen.github.io/) `data/changelog.md`
- [ ] Update version on [website](https://github.com/linscreen/linscreen.github.io/blob/master/_coverpage.md)
