...
See [translation instructions](https://github.com/linscreen/translation-instruction).
...
2. [Open an issue](https://github.com/aurelson101/linscreen/issues/new) and describe the issue you are having - you could include:
     - Screenshots
     - Ways to reproduce the issue.
     - Your LinScreen version.
...
The best way to fund LinScreen is to create a bounty here: https://rysolv.com/issues
