...
class LinScreenDaemon : public QObject
{
    Q_OBJECT
public:
    static void start();
    static LinScreenDaemon* instance();
    ...
    void sendTrayNotification(
      const QString& text,
      const QString& title = QStringLiteral("LinScreen Info"),
...
private:
    ...
    static LinScreenDaemon* m_instance;

#if !(defined(Q_OS_MACOS) || defined(Q_OS_WIN))
    friend class LinScreenDBusAdapter;
#endif
};
