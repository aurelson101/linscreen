...
// icon (saved somewhere in /snap/linscreen/...) is passed
#ifndef LINSCREEN_ICON
#define LINSCREEN_ICON "linscreen"
#endif
...
{
    sendMessage(text, tr("LinScreen Info"), savePath);
}
